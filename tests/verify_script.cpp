...
TEST_CASE("cltv verification")
{
  ...
  auto tx_locktime_100 = *bitcoin::parse_transaction(
...
TEST_CASE("csv verification")
{
  ...
  auto tx_sequence_10 = *bitcoin::parse_transaction(
...
TEST_CASE("p2tr scriptpath verification")
{
  ...
  auto amount = 503185 * bitcoin::units::satoshi;
  auto outputs = std::array{
    bitcoin::tx_output{
